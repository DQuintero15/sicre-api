        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedAt = table.Column<DateTime>(type: "timestamptz", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    ExpiresAt = table.Column<DateTime>(type: "timestamptz", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamptz", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    HasChangedDefaultPassword = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerationMode = table.Column<string>(type: "varchar(50)", nullable: false),
                    DueDateRuleType = table.Column<string>(type: "varchar(50)", nullable: false),
                    DueDateDay = table.Column<int>(type: "integer", nullable: true),
                    DueDateMonth = table.Column<int>(type: "integer", nullable: true),
                    DueDateDatesDefinition = table.Column<string>(type: "jsonb", nullable: true),
                    OriginalDueDateText = table.Column<string>(type: "text", nullable: true),
                    AlertEarlyDays = table.Column<int>(type: "integer", nullable: false, defaultValue: 15),
                    AlertFollowUpDays = table.Column<int>(type: "integer", nullable: false, defaultValue: 5),
                    AlertCriticalDays = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    ...
                    EntityUploadResponsibleUserId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoNotify = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    UpdatedByUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamptz", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleFileId = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
